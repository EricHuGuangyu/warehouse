...
fun HomeScreen(navController: NavHostController) {
    ...
    Row(
        modifier = Modifier.fillMaxWidth().padding(top = 32.dp).background(Color.White),
            ...
            onClick = {
                ...
                if (ContextCompat.checkSelfPermission(
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(
                        ...
                        Toast.makeText(context, "Camera permission is needed for scanning.", Toast.LENGTH_SHORT).show()
